...
- 综合分变化：扣分保持 -30（封顶），综合分保持 50.7（D 级偏差，排名不变）
...
**合理性检查**：
- 维度评分（设计 52.4 / 关键词 57.6 / 出价 51.9 / 时间 77.4 扣分前 / 47.4 扣分后）的相对大小关系应保持
- 时间维度扣分前 77.4 仍为最高分，扣分后 47.4 变为最低分
- 综合分 50.7 保持 D（偏差）评级不变
