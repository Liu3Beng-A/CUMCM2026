...
| 4 | **Q3 投放策略优化** | ⏸ **待重做**（**幻觉事故清理完成 2026-09-12 + BIAS_v2 修订完成 2026-09-12 17:27**）| 真实需求：2025-02-01~08 + 2025-08-01~08 共 16 天；决策粒度 推广单元×关键词×天；预算 ≤2025 同期；预测 4 指标（展位/点击/浏览/注册）；代理精度校验（D-022）+ 代理敏感性 ±30%（D-023）|
| 5 | **Q4 不确定性优化** | ⏸ **待重做**（**幻觉事故清理完成 2026-09-12 + BIAS_v2 修订完成 2026-09-12 17:27**）| 真实需求：2026-09-11~17 共 7 天；决策粒度 推广单元×关键词×天；6 因素不确定性（竞价/展现/展现位/点击/浏览/注册）；预测 6 个期望值；预算 23,488.02 元（同期口径，D-024）|
